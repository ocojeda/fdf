...
#    Updated: 2017/02/27 10:10:04 by myernaux         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = bonus.c ft_atoi_hexa.c proyection.c map.c line.c parse.c matrix.c bonus1.c aux_fdf.c fl_to_int.c line2.c ft_error.c keycode.c
